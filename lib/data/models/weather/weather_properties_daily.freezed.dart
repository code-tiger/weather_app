...
part of 'weather_properties_daily.dart';
...
/// @nodoc
mixin _$WeatherPropertiesDaily {
  ...
  /// Create a copy of WeatherPropertiesDaily
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $WeatherPropertiesDailyCopyWith<WeatherPropertiesDaily> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $WeatherPropertiesDailyCopyWith<$Res> {
  factory $WeatherPropertiesDailyCopyWith(WeatherPropertiesDaily value,
          $Res Function(WeatherPropertiesDaily) then) =
      _$WeatherPropertiesDailyCopyWithImpl<$Res, WeatherPropertiesDaily>;
  @useResult
  $Res call(
      {List<String> time,
...
/// @nodoc
class _$WeatherPropertiesDailyCopyWithImpl<$Res,
        $Val extends WeatherPropertiesDaily>
    implements $WeatherPropertiesDailyCopyWith<$Res> {
  _$WeatherPropertiesDailyCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$WeatherPropertiesDailyImplCopyWith<$Res>
    implements $WeatherPropertiesDailyCopyWith<$Res> {
  factory _$$WeatherPropertiesDailyImplCopyWith(
          _$WeatherPropertiesDailyImpl value,
          $Res Function(_$WeatherPropertiesDailyImpl) then) =
      __$$WeatherPropertiesDailyImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {List<String> time,
...
/// @nodoc
class __$$WeatherPropertiesDailyImplCopyWithImpl<$Res>
    extends _$WeatherPropertiesDailyCopyWithImpl<$Res,
        _$WeatherPropertiesDailyImpl>
    implements _$$WeatherPropertiesDailyImplCopyWith<$Res> {
  __$$WeatherPropertiesDailyImplCopyWithImpl(
      _$WeatherPropertiesDailyImpl _value,
      $Res Function(_$WeatherPropertiesDailyImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$WeatherPropertiesDailyImpl(
      time: null == time
          ? _value._time
          : time // ignore: cast_nullable_to_non_nullable
              as List<String>,
...
class _$WeatherPropertiesDailyImpl extends _WeatherPropertiesDaily {
  ...
  List<double> get windGusts10mMax {
    ...
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_windGusts10mMax);
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$WeatherPropertiesDailyImpl &&
  ...
  _$$WeatherPropertiesDailyImplCopyWith<_$WeatherPropertiesDailyImpl>
      get copyWith => __$$WeatherPropertiesDailyImplCopyWithImpl<
